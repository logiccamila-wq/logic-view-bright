...
// .wrangler/tmp/pages-4zGbCh/functionsWorker-0.36625175035921453.mjs
...
var onRequest4 = /* @__PURE__ */ __name2(async ({ env }) => {
  const supabaseUrl = env.SUPABASE_URL || env.VITE_SUPABASE_URL || "";
  const serviceKey = env.SUPABASE_SERVICE_ROLE_KEY || "";
  if (!supabaseUrl || !serviceKey) return new Response(JSON.stringify({ error: "Missing SUPABASE_URL or SUPABASE_SERVICE_ROLE_KEY" }), { status: 500 });
...
var onRequest7 = /* @__PURE__ */ __name2(async ({ request, env }) => {
  ...
  try {
    ...
    const upsertModule = /* @__PURE__ */ __name2(async (key) => {
...
var onRequest8 = /* @__PURE__ */ __name2(async () => {
  const now = Date.now();
...
var onRequest9 = /* @__PURE__ */ __name2(async ({ request }) => {
  if (request.method !== "POST") return new Response(JSON.stringify({ error: "Method not allowed" }), { status: 405 });
...
var onRequest11 = /* @__PURE__ */ __name2(async ({ env }) => {
  const supabaseUrl = env.SUPABASE_URL || env.VITE_SUPABASE_URL || "";
  const serviceKey = env.SUPABASE_SERVICE_ROLE_KEY || "";
  if (!supabaseUrl || !serviceKey) return new Response(JSON.stringify({ error: "Missing SUPABASE_URL or SUPABASE_SERVICE_ROLE_KEY" }), { status: 500 });
  const h = { Authorization: `Bearer ${serviceKey}`, apikey: serviceKey };
...
var onRequest13 = /* @__PURE__ */ __name2(async ({ env }) => {
  const supabaseUrl = env.SUPABASE_URL || env.VITE_SUPABASE_URL || "";
  const serviceKey = env.SUPABASE_SERVICE_ROLE_KEY || "";
  const h = { Authorization: `Bearer ${serviceKey}`, apikey: serviceKey, "Content-Type": "application/json" };
  const demo = {
  ...
  const tryInsert = /* @__PURE__ */ __name2(async (table, rows) => {
    if (!supabaseUrl || !serviceKey) {
...
var onRequest15 = /* @__PURE__ */ __name2(async ({ request, env }) => {
  ...
  const ensureRole = /* @__PURE__ */ __name2(async (userId, role) => {
  ...
  const upsertModule = /* @__PURE__ */ __name2(async (key, name, category, description) => {
    const url = `${supabaseUrl}/rest/v1/modules?on_conflict=key`;
    const r = await fetch(url, {
      method: "POST",
      headers: { ...h, Prefer: "resolution=merge-duplicates" },
  ...
  const upsertPermission = /* @__PURE__ */ __name2(async (profile_key, module_key, allowed = true) => {
...
var onRequest16 = /* @__PURE__ */ __name2(async ({ env }) => {
  const e = env;
...
var onRequest17 = /* @__PURE__ */ __name2(async ({ request, next, env }) => {
  const url = new URL(request.url);
...
// .wrangler/tmp/bundle-QScVOW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-QScVOW/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.36625175035921453.js.map
