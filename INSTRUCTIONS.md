...
Alternatively, you can copy the example environment file included in the repo:

```bash
cp .env.example .env
# Edit .env to set FOUNDRY_ENDPOINT and AGENT_ID
```

## More examples

Check out [Azure AI Projects client library for JavaScript](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/ai/ai-projects/README.md) for more information on using this SDK.
